...
int main() {
    ...
    do {
        cout << "MENU:" << endl;
        cout << "1. Ingresar origen y destino" << endl;
        cout << "2. Salir" << endl;
        ...
        switch (opcion) {
            case 1:
                ...
                if (origen < 0 || origen >= matrizAdyacencia.size() || destino < 0 || destino >= matrizAdyacencia.size()) {
                    cout << "Los vértices ingresados no son válidos." << endl;
                } else {
